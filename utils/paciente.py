...
def ingresar_paciente() -> dict:
    ...
    genero = validar_entero(
        "Género (1 - Masculino / 2 - Femenino): ", opciones=[1, 2])
    edad = validar_entero("Edad (mayor o igual a 10 años): ", minimo=10)
    diabetes = validar_entero(
        "Antecedentes diabeticos (1 - Sí / 2 - No): ", opciones=[1, 2])
    hipertension = validar_entero(
        "Antecedentes hipertensivos (1 - Sí / 2 - No): ", opciones=[1, 2])
    cardiovascular = validar_entero(
        "Antecedentes cardiovasculares (1 - Sí / 2 - No): ", opciones=[1, 2])
